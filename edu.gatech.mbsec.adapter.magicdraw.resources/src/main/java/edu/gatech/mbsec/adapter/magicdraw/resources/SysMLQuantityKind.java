...
public class SysMLQuantityKind extends AbstractResource{
	...
	@OslcName("symbol")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8080/oslc4jmagicdraw/services/sysml-rdfvocabulary#QuantityKind_symbol")
	@OslcTitle("symbol")
	@OslcValueType(ValueType.XMLLiteral)
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8080/oslc4jmagicdraw/services/sysml-rdfvocabulary#QuantityKind_description")
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8080/oslc4jmagicdraw/services/sysml-rdfvocabulary#QuantityKind_definitionURI")
