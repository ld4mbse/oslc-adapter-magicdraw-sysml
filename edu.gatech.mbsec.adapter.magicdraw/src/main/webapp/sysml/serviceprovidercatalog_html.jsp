...
<title>MagicDraw OSLC Adapter: Service Provider Catalog</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: Service Provider Catalog</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Service Provider Catalog </span>MagicDraw</h1>
		<br>
