...
<%	
	...
	List<EAttribute> eAttributes = (List<EAttribute>) eClass
			.getEAllAttributes();
	List<String> possibleOwnerElements = (List<String>) request.getAttribute("possibleOwnerElements");
	List<String> possibleBlocks = (List<String>) request.getAttribute("possibleBlocks");
	List<String> possibleRequirements = (List<String>) request.getAttribute("possibleRequirements");
	...
	<div>
		<form id="Create" action=<%=creatorUri%> method="POST">
			...
			<table style="clear: both;">
				...
				<!--  
				<tr>
					<th class="field_label">Inherited Block</th>
					<td><select name="inheritedBlock">
							<%
				...
				<tr>
					<th class="field_label">Satisfies Requirement</th>
					<td><select name="satisfies">
							<%
								for (String c : possibleRequirements) {
							%>
							<option value="<%=c%>"><%=c%></option>
							<%
								}
				...
				<tr>
					...
					<td><select name="ownerElement">
							<%
								for (String c : possibleOwnerElements) {
							%>
							<option value="<%=c%>"><%=c%></option>
							<%
								}
