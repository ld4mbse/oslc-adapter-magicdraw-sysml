...
<title>MagicDraw OSLC Adapter: Resource Shapes</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">MagicDraw OSLC Adapter: Resource Shapes</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Resource Shapes </span>MagicDraw</h1>
		<br>
